...
public class AirQualityService {
    ...
    */
    ...
    // 일반 인증키
    // KP3OW%2FIgF46HjBjfKLfvalHbVNIFOxz9eg%2FxJBrJPrA6nB8UAOyoP9St0M%2B%2BG6YR6ILkRwHNvZ55AJWL1OMG5A%3D%3D
    private final String SERVICE_KEY = "KP3OW%2FIgF46HjBjfKLfvalHbVNIFOxz9eg%2FxJBrJPrA6nB8UAOyoP9St0M%2B%2BG6YR6ILkRwHNvZ55AJWL1OMG5A%3D%3D";

    public String getAirQuality(String searchDate) {


        // RestTemplate HTTP 요청을 보낼 때 사용
        // RESTful API 통신 할 때 사용
        // GET POST PUT DELETE 등의 HTTP 메서드를 사용할 수 잇음
        // json, xml 데이터 받을수 있음
